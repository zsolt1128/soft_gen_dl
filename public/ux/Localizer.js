...
console.log('getUrlPrefix()', this.getUrlPrefix());
        Ext.Ajax.request({
        //    url : "/bundles/zsvirsoftertekesites/munkak/app/locale/" + locale + ".js",
//	    url : this.getUrlPrefix() + "/app/locale/" + locale + ".js",
	    url : this.getUrlPrefix() + "/" + locale + ".js",
//	    https://192.168.56.2/bundles/zsvirsoftertekesites/munkak/app/locale/en.js
            async : false,
...
//		    if (entry.value) {
//			var val = (entry.value).replace('&nbsp;', ' ');
                        localeStrings.add(entry.key, entry.value);
//			localeStrings.add(entry.key, val);
//		    }
                });
